...
import "./globals.css";
import Link from "next/link"; // ← これが絶対に必要！
    ...
    <html lang="ja">
      <body className={`${inter.className} antialiased bg-black text-white`}>
        <header className="h-16 w-full flex relative overflow-hidden border-b border-cyan-500/30 z-50 bg-black shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
          ...
          {/* 【中央：MAIN NAVIGATION】 スマホでは4つ並ぶように調整 */}
          <div className="w-full md:w-1/3 bg-black flex items-center justify-center">
            <nav className="flex items-center space-x-3 md:space-x-12 font-mono">
              <Link href="/" className="group flex flex-col items-center">
                ...
                <span className="text-white text-[10px] md:text-lg font-black tracking-widest group-hover:text-cyan-400 transition-all">[ HOME ]</span>
              </Link>
              ...
              <Link href="/archives" className="group flex flex-col items-center">
                ...
                <span className="text-white text-[10px] md:text-lg font-black tracking-widest group-hover:text-pink-400 transition-all">[ LOGS ]</span>
              </Link>
              ...
              <Link href="/company-profile.html" className="md:hidden group flex flex-col items-center">
                ...
                <span className="text-white text-[10px] font-black tracking-widest group-hover:text-yellow-400 transition-all">[ CORP ]</span>
              </Link>
            </nav>
          </div>

          {/* 【右：EXTERNAL LINKS】 PCのみ */}
